...
This repository is used to store public images for personal projects, notes, blog posts, and documentation.  
本仓库用于存放个人项目、笔记、博客文章和文档中使用的公开图片资源。

---

## Purpose / 仓库用途

This repo works as a simple image hosting repository for:  
本仓库可作为一个简单的在线图片仓库，用于存放：

- blog post images / 博客配图
- profile avatars / 头像图片
- project screenshots / 项目截图
- icons and logos / 图标与 Logo
- social post covers / 社交媒体封面图
- documentation assets / 文档插图资源
...
After uploading an image, open the file and click Raw to get the direct link.
